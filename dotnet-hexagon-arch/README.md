...
1. (DONE) Make use of custom exceptions to handle known errors within your code
2. Make the data persisted, instead of in-memory
3. (DONE) Add documentation to your API (e.g. /swagger/v1/swagger.json)
4. "Containerize" your application (e.g. Dockerfile)

## Additionals:

Instead add a persistence and containerize, I preferred let it in Memory and to make other additionals.

1. (DONE) Add PATCH Method in Controlers and Tests
2. (DONE) Add Examples of Entities in Swagger documentation
3. (DONE) Make a version in dot NET 6 using Minimal APIs

## Whats is missing?:

Of course, besides containerization and data presentation, there are other things I wish to have time to do.

1. Make a version in dot NET 6 using gRPC
2. Add Logs
3. Add Integration tests and Smoke tests
